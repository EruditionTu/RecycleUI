...
const createDoc = () => {
  ...
  createFile(`docs/Components/${docName}.md`).then(() => {
        ...
        createFileBox(`${componentPath}/style`)
          .then(() => {
            createFile(`${componentPath}/style/index.less`)
              .catch(() => {
                throw new Error(`fail to create file ${componentPath}/style/index.less `)
              })
            createFile(`${componentPath}/style/index.tsx`)
              .catch(() => {
                throw new Error(`fail to create file ${componentPath}/style/index.tsx `)
              })
          })
          .catch(() => {
