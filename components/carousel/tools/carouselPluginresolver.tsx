...
let carouselPluginresolver:(carouselProps:any)=>carouselPluginresolverReturnTypes;

carouselPluginresolver=(carouselProps:any):carouselPluginresolverReturnTypes=>{
    //处理Carousel的Plugin去调用对应的Plugin函数
    const carouselPlugins = carouselProps?.plugins?.map((plugin:pluginsTypes)=>{
