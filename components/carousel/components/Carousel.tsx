...
const Carousel: React.FC<CarouselPropsType> = (
  ...
  //获取轮播元素
  const children: Array<React.ReactNode> = getChildren(
    props.children,
    props.slides
  );
   ...
   */
  const onMouseUpTouchEnd = React.useCallback(
    (e): void => {
      if (slideMovement.dragStart !== null) {
  ...
  return (
    <div className={"carousel-container"}>
      <div
        className={classnames("carousel", props.calssName)}
