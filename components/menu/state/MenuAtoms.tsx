...
//sub展开方式
export const MenuTriggerSubMenuActionState: RecoilState<"hover" | "click"> =
  atom<"hover" | "click">({
    key: "MenuTriggerSubMenuActionState",
    default: "hover",
  });
//menu主题
export const MenuThemeState: RecoilState<"light" | "dark"> = atom<
  "light" | "dark"
>({
  key: "MenuThemeState",
  default: "light",
...
//menu模式
export const MenuModeState: RecoilState<"horizontal" | "inline" | "vertical"> =
  atom<"horizontal" | "inline" | "vertical">({
    key: "MenuModeState",
    default: "horizontal",
  });
//menu的item是否点击可选
